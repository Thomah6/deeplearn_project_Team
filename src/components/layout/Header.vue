...
>>>>>>> 27f74ce58d2549e1653bda40e887d856b2171858
    ...
    <nav class="px-4 sm:px-6 flex basis-full items-center w-full mx-auto">
      <div class="me-5 lg:me-0 lg:hidden">
        ...
        <router-link to="/"
          ...
          aria-label="Preline" style="font-family: 'Caveat', cursive">
          DeepLearn.io
        </router-link>
      </div>
...
>>>>>>> 27f74ce58d2549e1653bda40e887d856b2171858
        ...
        <div class="flex flex-row items-center justify-end gap-1">
          ...
          <button type="button"
            class="md:hidden size-9.5 relative inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-800 hover:bg-sky-200 focus:outline-hidden focus:bg-sky-200 dark:text-white dark:hover:bg-slate-800 dark:focus:bg-slate-800">
...
<<<<<<< HEAD
          <!-- Dropdown Menu -->
          <div v-if="isLogin && user" class="hs-dropdown [--placement:bottom-right] relative inline-flex">
            <button id="hs-dropdown-account" type="button"
              class="size-9.5 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-800 focus:outline-hidden dark:text-white">
              <img class="shrink-0 size-9.5 rounded-full" :src="image" alt="Avatar" />
=======
  ...
  <div class="-mt-px">
    <div
      ...
      <div class="flex items-center py-2">
        <button type="button"
          class="size-8 flex justify-center items-center gap-x-2 border border-gray-200 text-gray-800 hover:text-gray-500 rounded-lg focus:outline-hidden dark:border-neutral-700 dark:text-neutral-200 dark:hover:text-neutral-500"
